...
if ($GLOBAL["sitekey"] == 1 && $GLOBAL["database"] == 1) {
    ...
    if (isset($_POST["savebutton"])) {
        ...
        $catId = getRealEstateById((int)$id);

        editRealEstateFields($editRubricItem);
        ...
        <div class=\"RoundText\">
            <table>
                ...
                <tr class=\"TRLine1\">
                    ...
                    <td class=\"LongInput\">
                        <input name=\"dname\" id=\"dname\" type=\"text\" class=\"JsVerify2\" maxlength=\"80\" value=\"{$rubricItem['name']}\">
                    </td>
                </tr>";
