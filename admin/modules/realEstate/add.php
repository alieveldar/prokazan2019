...
if ($GLOBAL["sitekey"] == 1 && $GLOBAL["database"] == 1) {
    ...
    if (isset($_POST["savebutton"])) {
        ...
        $rubricId = createRealEstate($createRubricItem);
    ...
    $AdminText .= "
        <div class=\"RoundText\">
            <table>
                ...
                <tr class=\"TRLine0\">
                    <td class=\"VarText\">Название жилого комплекса<star>*</star></td>
                    <td class=\"LongInput\">
                        <input name=\"dname\" id=\"dname\" type=\"text\" class=\"JsVerify2\" maxlength=\"80\">
