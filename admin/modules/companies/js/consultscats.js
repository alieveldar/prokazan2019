...
function ActionAndUpdate(id, act, tab, pid) {CloseBlank(); JsHttpRequest.query('modules/companies/consultscats-JSReq.php',{'id':id,'act':act,'tab':tab,'pid':pid},function(result,errors){ if(result){ $("#Tgg").html(result["content"]); $("#Msg2").html("Данные успешно сохранены"); $("#Msg2").removeClass(); $("#Msg2").addClass("SuccessDiv"); $('#Tgg input').tzCheckbox({labels:['да ','нет']}); }},true); }
