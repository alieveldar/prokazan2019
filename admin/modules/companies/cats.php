...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
	...
	if (isset($P["addbutton"])) {
		...
		$res=DB("INSERT INTO $table (`stat`,`name`,`text`,`pic`,`pid`) VALUES (".$stat.", '".$P["name"]."', '".$P["text"]."', '".$picname."', ".$P["pid"].")");
	...
	$AdminText.=$C15.'<h2 style="float:left;">Редактирование разделов и категорий компаний</h2>
