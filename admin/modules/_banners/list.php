...
if ($GLOBAL["sitekey"]==1 && $GLOBAL["database"]==1) {
	...
	$AdminText='<h2 style="float:left;">Список рекламных материалов</h2>'."<div class='LinkG' style='float:right;'><a href='?cat=banners_add'>Добавить баннер</a></div>".$C5.$_SESSION["Msg"].$C5."<div id='Msg2' class='InfoDiv'>Вы можете редактировать и удалять записи</div>";
	...
	// ПРАВАЯ КОЛОНКА
	$AdminRight="<div class='C20'></div><h2>Типы баннеров</h2><div class='SecondMenu'><a href='?cat=".$alias."_type'>Редактировать список</a></div>";
	$AdminRight.="<div class='RoundText' id='Tgg'><table>".$types."</table></div>".$C10."";
