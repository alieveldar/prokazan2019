...
$html=file_get_contents('../template/403.html');
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
$P=$_POST;

if (isset($P["editbutton"])) {
	file_put_contents ('../template/403.html', stripslashes($P["text"]));
	$_SESSION["Msg"]="<div class='SuccessDiv'>Cтраница сохранена!</div>";
	@header("location: ".$_SERVER["REQUEST_URI"]); exit();
}
	
// ФОРМА ДОБАВЛЕНИЯ
	$AdminText='<h2>Редактирование страницы ошибки 403 (Доступ запрещён)</h2>'.$_SESSION["Msg"];
