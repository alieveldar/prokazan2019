...
if ($('.texteditors' ).size()!=0) { $('.texteditors' ).ckeditor({customConfig:'/admin/texteditor/config_sm.js'}); }
 ...
 element: document.getElementById('uploader'), request: {
