...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
	...
	if ($node["zenyandex"]==1) { $chk11="checked"; }
	...
	<tr class='TRLine1'>
		<td width='1%'><input name='zenyandex' id='zenyandex' type='checkbox' value='1' $chk11></td><td width='20%'>Отправить в <b>Яндекс.Дзен</b></td>
	</tr>
	</table></div>";
