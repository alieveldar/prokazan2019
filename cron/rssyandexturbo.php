...
<item turbo="true">
    ...
    if ($at["pic"] != "") {
        $rsstext .= '<figure>
	<img src="http://' . $_SERVER["HTTP_HOST"] . '/userfiles/picpreview/' . $at["pic"] . '" type="image/jpeg" /></figure>';
    }
    foreach ($images as $image) {
        $rsstext .= '
	<img src="http://' . $_SERVER["HTTP_HOST"] . $image['src'] . '" type="' . $image['type'] . '" /> </figure>';
    }
	$rsstext .='
	<p>' . $content . '</p>';

    $rsstext .= ']]> </turbo:content>
</item>';
}
