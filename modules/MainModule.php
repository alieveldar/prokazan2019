...
$JSmodules = array(
	...
	"Основной JS сайта"  				=> "/modules/standart/js/MainModule.js?t=01032019",
...
$CSSmodules = array(
    ...
    "Prokazan Styles"		=> '/template/standart/style.css?t=031218',
...
$mobileWidth = isset($_SESSION['full']) && $_SESSION['full'] ? '1440px' : 'device-width';
...
$MENU["newmenu"]=str_replace("<!--USER-->", $Page["UserAuth"], $MENU["newmenu"]);
...
$RENDER.=$ICON;
$RENDER.=$MOBILE;
$RENDER.='<meta name="yandex-verification" content="1d9c554bc9c36a46" />';
...
$RENDER.= "<script
          ...
          onload='javascript:renderDelivery(\"5caf17464bb42\")'>
        </script>";
...
$RENDER.='<!--#include virtual="/adblockrecovery.ru"  -->';
